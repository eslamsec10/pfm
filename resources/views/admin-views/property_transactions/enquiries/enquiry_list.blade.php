                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button type="submit" class="btn btn--primary">
                                            {{ ui_change('search', 'property_transaction') }}
                                        </button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0">
                                ...
                                <div class="d-flex flex-wrap justify-content-lg-end align-items-center gap-2">
                                    ...
                                    <select name="status" class="form-control w-auto">
                                        ...
                                        <option value="{{  $enquiry_request_status_item->id }}">{{ $enquiry_request_status_item->name }}</option>
                                        @endforeach 
                                    </select>
                                    ...
                                    <button type="button" data-target="#filter" data-toggle="modal"
                            ...
                            <table id="datatable"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ ui_change('enquiry_date', 'property_transaction') }}
                                        </th>
                                        ...
                                        <th class="text-center">{{ ui_change('booking_status', 'property_transaction') }}
                                        </th>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12 col-lg-4 col-xl-3">
                                        ...
                                        <select name="booking_status" class="form-control select2">
                                            ...
                                            <option value="enquiry">{{ ui_change('enquiry', 'property_transaction') }}
                                            </option>
                                    ...
                                    <div class="col-md-12 col-lg-4 col-xl-3">
                                        ...
                                        <select name="enquiry_request_status" class="form-control select2">
                                            <option value="-1">
                                                {{ ui_change('all_enquiry_request_status', 'property_transaction') }}
                                            </option>
                                            @foreach ($enquiry_request_status as $enquiry_request_status_item)
                                    ...
                                    <div class="col-md-12 col-lg-4 col-xl-3">
                                        ...
                                        <select name="enquiry_status" class="form-control select2">
                                            <option value="-1">
                                                {{ ui_change('all_enquiry_status', 'property_transaction') }}</option>
