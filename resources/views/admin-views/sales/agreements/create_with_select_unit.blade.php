                        ...
                        <div class="col-md-12 col-lg-4 col-xl-6">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('tenant' , 'property_transaction')  }}
                                    ...
                                    <span
                                        class="starColor " style="font-size: 18px; "> *</span>
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" id="total-no-units" class="form-control"
                                    name="total_no_of_required_units" readonly value="{{ count($agreement_units) }}">
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="relocation_date"
                                    class="relocation_date form-control main_date" placeholder="DD/MM/YYYY">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="period_from" id="period_from_date"
                                    class="period_from form-control" onchange="(proposal_period_date_clc(),unit_change_main_date())"
                            ...
                            <div class="form-container mt-3">
                                <div class="form-row">
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        ...
                                        <div class="form-group">
                                            <label for="building">{{ ui_change('property' , 'property_transaction') }} <span
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label for="period-from">{{ ui_change('period_from_to' , 'property_transaction') }}
                                            ...
                                            <div style="display: flex; gap: 10px;">
                                                <input type="text" name="period_from-{{ $loop->index + 1 }}"
                                                    ...
                                                    onchange="agreement_unit_date_clc({{ $loop->index + 1 }})"
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 col-lg-4 col-xl-6">
                                        ...
                                        <div class="form-group">
                                            <label for="area-measurement">{{ ui_change('unit' , 'property_transaction') }} <span
                                                    class="starColor " style="font-size: 18px; "> *</span> </label>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label for="total-area">{{ ui_change('rent_amount' , 'property_transaction') }} <span
                                                    class="starColor " style="font-size: 18px; "> *</span> </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control main_date"
...
@push('script')
    ...
    <script>
        ...
        function vat_amount_func(i) {
            ...
            $('input[name="vat_amount-' + i + '"]').val((0).toFixed(decimals));
            $('input[name="vat_percentage-' + i + '"]').val((0).toFixed(decimals));
            $('input[name="total_net_rent_amount-' + i + '"]').val((0).toFixed(decimals));
