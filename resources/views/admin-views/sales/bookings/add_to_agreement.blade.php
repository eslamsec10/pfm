...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{ route('sales.booking.store_to_agreement') }}" method="POST"
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-6">
                            <div class="form-group">
                                ...
                                <input readonly type="text" name="agreement_no" class="form-control"
                                    value="{{ SalesAgreementNo() }}">
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-4 col-xl-6">
                            <div class="form-group">
                                <label for="">{{ ui_change('agreement_date', 'property_transaction') }}<span
                                        class="text-danger"> *</span></label></label>
                                <input type="text" class="form-control" name="agreement_date" id="add_to_agreement_date"
                                    class="form-control"
                                    value="{{ \Carbon\Carbon::parse($booking->booking_date)->format('d-m-Y') }}">
                                <input type="hidden" class="form-control" name="booking_id" class="form-control"
                                    value="{{ $booking->id }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="customer_type" readonly
                                    class="form-control" value="{{ $booking->customer?->type }}">
                            </div>
                            @error('customer_type')
                                <div class="invalid-feedback">
                                    {{ $message }}
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 customer_form @if ($booking->customer?->type == 'individual') d-none @endif company-form"
                            id="company-form">

                            @include('admin-views.sales.enquiries.company_form')

                        </div>
                        <div class="col-md-12 customer_form @if ($booking->customer?->type == 'company') d-none @endif personal-form"
                            id="personal-form">
            ...
            <div id="main-content">
                @php
                    $unitCount = count($booking->booking_units);
                @endphp
                @foreach ($booking->booking_units as $item)
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            @if ($unitCount > 1)
                                <a type="button" class="btn btn-danger btn-sm"
                                    href="{{ route('sales.booking.empty_unit_from_booking_unit', $item->id) }}">
