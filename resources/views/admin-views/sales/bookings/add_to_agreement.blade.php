...
@section('content')
    <div class="content container-fluid">
        ...
        <!-- Form -->
        <form class="product-form text-start" action="{{ route('booking.store_to_agreement') }}" method="POST"
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="agreement_date" name="agreement_date"
                                    class="form-control"
                                    value="{{ \Carbon\Carbon::parse($agreement->booking_date)->format('d/m/Y') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-6">
                            <div class="form-group">
                                <label for="name"
                                    class="title-color">{{ ui_change('tenant', 'property_transaction') }}
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label
                                    for="">{{ ui_change('total_no_of_required_units', 'property_transaction') }}</label>
            ...
            <input type="hidden" name="booking_id" value="{{ $agreement->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="employee_id">
                                    ...
                                    <option value="{{ $employee_item->id }}"
                                        {{ $employee_item->id == $agreement->booking_details->employee_id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="agent_id">
                                    ...
                                    <option value="{{ $agent_item->id }}"
                                        {{ $agent_item->id == $agreement->booking_details->agent_id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="decision_maker"
                                    value="{{ $agreement->booking_details->decision_maker }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="decision_maker_designation"
                                    value="{{ $agreement->booking_details->decision_maker_designation }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="current_office_location"
                                    value="{{ $agreement->booking_details->current_office_location }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="reason_of_relocation"
                                    value="{{ $agreement->booking_details->reason_of_relocation }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="budget_for_relocation_start"
                                    value="{{ $agreement->booking_details->budget_for_relocation_start }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mt-2" name="budget_for_relocation_end"
                                    value="{{ $agreement->booking_details->budget_for_relocation_end }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_of_emp_staff_strength"
                                    value="{{ $agreement->booking_details->no_of_emp_staff_strength }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="relocation_date" class="relocation_date  form-control"
                                    ...
                                    value="{{ isset($agreement->booking_details->relocation_date) ? \Carbon\Carbon::createFromFormat('Y-m-d', $agreement->booking_details->relocation_date)->format('d/m/Y') : \Carbon\Carbon::now()->format('d/m/Y') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="period_from"
                                    ...
                                    value="{{ isset($agreement->booking_details->period_from) ? \Carbon\Carbon::createFromFormat('Y-m-d', $agreement->booking_details->period_from)->format('d/m/Y') : \Carbon\Carbon::now()->format('d/m/Y') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="price" class="title-color"> </label>
                                <input type="text" name="period_to" class="period_to form-control main_date mt-2"
                                    placeholder="DD/MM/YYYY"
                                    value="{{ isset($agreement->booking_details->period_to) ? \Carbon\Carbon::createFromFormat('Y-m-d', $agreement->booking_details->period_to)->format('d/m/Y') : \Carbon\Carbon::now()->format('d/m/Y') }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body mt-3">
                            ...
                            <div class="form-container mt-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex; gap: 10px;">
                                                <input type="text" name="period_from-{{ $item->id }}"
                                                    ...
                                                    onchange="(proposal_period_date_clc())" id="period-from"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex; gap: 10px;">
                                                <input type="text" name="period_to-{{ $item->id }}"
                                                    id="period-to" class="form-control mt-2 main_data text-white general_period_date_to"
                                ...
                                @php
                                    ...
                                    $unit_services_count =
                                        App\Models\BookingUnitsService::where('booking_unit_id', $item->id)->count() ??
                                        0;
                                @endphp
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="area-measurement" name="payment_mode-{{ $item->id }}"
                                                required onchange="payment_mode_func({{ $item->id }})"
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3 d-none" id="amount-{{ $item->id }}">
                                        <div class="form-group">
                                            ...
                                            <input type="number" disabled name="amount-{{ $item->id }}"
                                                ...
                                                value="{{ number_format($item->amount, $company->decimals, '.', '') }}"
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <select id="area-measurement" name="rent_mode-{{ $item->id }}" required
                                                class="js-select2-custom form-control" required>
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xl-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            class="form-control agreement_date_general"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control main_date agreement_date_general"
                                                    name="lease_break_date-{{ $item->id }}" value="{{ \Carbon\Carbon::createFromFormat('Y-m-d',$item->lease_break_date)->format('d/m/Y')  }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <select name="notice_period-{{ $item->id }}"
                                                    ...
                                                    <option>{{ ui_change('three_month', 'property_transaction') }}
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
...
@push('script')
    <script>
        ...
        flatpickr(".agreement_date_general", {
    ...
    <script>
        ...
        function deleteItem(itemId) {
            ...
            $.ajax({
                url: "{{ route('booking.empty_unit_from_booking_unit', ':id') }}".replace(':id', itemId),
                type: "GET",
                data: {
                    _token: "{{ csrf_token() }}"
                },
