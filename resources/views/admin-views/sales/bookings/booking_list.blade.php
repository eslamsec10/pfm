                    ...
                    <div class="px-3 py-4">
                        <div class="row align-items-center">
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-custom input-group-merge">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="{{ ui_change('booking_search', 'property_transaction') }}"
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                ...
                                {{-- @can('create_booking') --}}
                                <a href="{{ route('sales.booking.create') }}" class="btn btn--primary">
                                    <i class="tio-add"></i>
                            ...
                            <table id="datatable"
                                ...
                                <thead class="thead-light thead-50 text-capitalize">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ ui_change('booking_no', 'property_transaction') }}
                                        </th>
                                        <th class="text-center">{{ ui_change('booking_date', 'property_transaction') }}
                                        </th>
                                ...
                                <tbody>
                                    @foreach ($bookings as $k => $booking_item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ $booking_item->customer?->type == 'individual' ? $booking_item->customer?->name ?? ui_change('not_available', 'property_transaction') : $booking_item->customer?->company_name ?? ui_change('not_available', 'property_transaction') }}
                                            </td>
                                            <td class="text-center">
                                                {{ ucfirst($booking_item->customer->type) ?? ui_change('not_available', 'property_transaction') }}
                                            </td>
                                                ...
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    @if ($booking_item->booking_status == 'booking')
                                                        ...
                                                        <a class="btn btn-outline--primary "
                                                            ...
                                                            href="{{ route('sales.booking.add_to_agreement', [$booking_item->id]) }}">
                                                    ...
                                                    <a class="btn btn-outline--primary btn-sm square-btn"
                                                        title="{{ ui_change('edit', 'property_transaction') }}"
                                                        href="{{ route('sales.booking.edit', [$booking_item->id]) }}">
                                                        <i class="tio-edit"></i>
                                                    </a>
...
@push('script')
    ...
    <script>
        ...
        $('.subscription_status_form').on('submit', function(event) {
            ...
            $.ajax({
                url: "{{ route('sales.booking.status-update') }}",
                method: 'POST',
                data: $(this).serialize(),
        ...
        $(document).on('click', '.delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ route('sales.booking.delete') }}",
                        method: 'get',
                        data: {
                            id: id
                        },
