            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-6">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('tenant' , 'property_transaction')  }} <span class="starColor " style="font-size: 18px; "> *</span>
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" id="total-no-units" class="form-control"
                                    name="total_no_of_required_units" value="{{ count($booking_units) }}" readonly>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="relocation_date" class="relocation_date form-control main_date"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('booking_status' , 'property_transaction') }}
                                </label>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                <label for="price"
                                    class="title-color">{{ ui_change('period_from_to' , 'property_transaction')  }} <span class="starColor " style="font-size: 18px; "> *</span></label>
                                <input type="text" name="period_from" id="period_from_date"
                                    class="period_from form-control" placeholder="DD/MM/YYYY" onchange="proposal_period_date_clc(),unit_change_main_date()"   value="{{ \Carbon\Carbon::now()->format('d/m/Y') }}">
                            </div>
                        </div>
                         @php 
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="period_to" id="period_to_date"
                                    class="period_to form-control mt-2" placeholder="DD/MM/YYYY" value="{{ isset($periodFrom) ? \Carbon\Carbon::parse($periodFrom)->format('d/m/Y') :  \Carbon\Carbon::now()->subDay()->addYear()->format('d/m/Y') }}">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-container mt-3">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            <label
                                                for="period-from">{{ ui_change('period_from_to' , 'property_transaction')  }} <span class="starColor " style="font-size: 18px; "> *</span></label>
                                            <div style="display: flex; gap: 10px;">
                                                <input type="text" name="period_from-{{ $loop->index + 1 }}"
                                                    ...
                                                    onchange="booking_unit_date_clc({{ $loop->index + 1 }})"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex; gap: 10px;">
                                                <input type="text" name="period_to-{{ $loop->index + 1 }}"
                                                    ...
                                                    value="{{   isset($periodFrom) ? \Carbon\Carbon::parse($periodFrom)->format('d/m/Y') : \Carbon\Carbon::now()->addYear()->subDay()->format('d/m/Y')  }}">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3 d-none" id="area_measurement-{{ $loop->index + 1 }}">
                                        <div class="form-group">
                                            <label
                                                for="area-measurement">{{ ui_change('area_measurement' , 'property_transaction') }}</label>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3 d-none" id="total_area_amount-{{ $loop->index + 1 }}">
                                        <div class="form-group">
                                            <label for="total-area">{{ ui_change('total_area' , 'property_transaction') }}</label>
                                            <input type="number" disabled
                                                name="total_area_amount-{{ $loop->index + 1 }}" onkeyup="disabled_false({{ $loop->index + 1 }}),rent_mode_amount({{ $loop->index + 1 }})" class="form-control"
                                                placeholder="{{ number_format(0,$company->decimals,'.','') }}" value="{{ number_format($item->total_area_amount , $company->decimals,'.','') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" readonly
                                                ...
                                                value="{{ number_format(optional($item->rent_schedules->first())->rent_amount ?? 0, $company->decimals,'.','') }}" class="form-control text-white"
                                                step="0.001" placeholder="{{ number_format(0,$company->decimals,'.','') }}"  value="{{ optional($item->rent_schedules->first())->rent_amount }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4 col-xl-12">
                                        <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    class="form-control" step="0.001" placeholder="{{ number_format(0,$company->decimals,'.','') }}" onkeyup="deposite({{ $loop->index + 1 }})">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="form-group">
