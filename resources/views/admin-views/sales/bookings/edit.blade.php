...
@section('title', ui_change('edit_booking' , 'property_transaction') )
@php
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex gap-2"> 
                {{ ui_change('edit_booking' , 'property_transaction') }}
            </h2>
        </div>
        <!-- End Page Title -->
        ...
        <!-- Form -->
        <form class="product-form text-start" action="{{ route('booking.update', $booking->id) }}" method="POST"
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-6">
                            <div class="form-group">
                                <label for="">{{ ui_change('booking_date' , 'property_transaction')  }}</label>
                    ...
                    <div class="row">
                                ...
                                <select class="js-select2-custom form-control" name="employee_id">
                                    ...
                                    @foreach ($employees as $employee_item)
                                        <option value="{{ $employee_item->id }}"
                                            {{ $employee_item->id == $booking_details->employee_id ? 'selected' : '' }}>
                                ...
                                <select class="js-select2-custom form-control" name="agent_id">
                                    ...
                                    @foreach ($agents as $agent_item)
                                        <option value="{{ $agent_item->id }}"
                                            {{ $agent_item->id == $booking_details->agent_id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="decision_maker" value="{{ $booking_details->decision_maker }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="decision_maker_designation" value="{{ $booking_details->decision_maker_designation }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="current_office_location" value="{{ $booking_details->current_office_location }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="reason_of_relocation" value="{{ $booking_details->reason_of_relocation }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="budget_for_relocation_start" value="{{ $booking_details->budget_for_relocation_start }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mt-2" name="budget_for_relocation_end" value="{{ $booking_details->budget_for_relocation_end }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_of_emp_staff_strength" value="{{ $booking_details->no_of_emp_staff_strength }}">
                            </div>
                        </div> 
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="relocation_date" class="relocation_date form-control"
                                    placeholder="DD/MM/YYYY" value="{{ (isset($booking_details->relocation_date) ) ? \Carbon\Carbon::createFromFormat('Y-m-d',$booking_details->relocation_date )->format('d/m/Y') : '' }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control" name="booking_status_id" required>
                                    ...
                                    @foreach ($enquiry_statuses as $enquiry_status_item)
                                        <option value="{{ $enquiry_status_item->id }}" {{ $enquiry_status_item->id == $booking_details->booking_status_id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label for="name" class="title-color">{{ ui_change('agreement_status' , 'property_transaction')  }}
                                </label>
                                <select class="js-select2-custom form-control" name="booking_request_status_id" required>
                                    ...
                                    @foreach ($enquiry_request_statuses as $enquiry_request_status_item)
                                        <option value="{{ $enquiry_request_status_item->id }}" {{ $enquiry_request_status_item->id == $booking_details->booking_request_status_id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="period_from"
                                    class="period_from form-control period_from_date" onchange="period_date(),unit_change_main_date()"
                                    placeholder="DD/MM/YYYY" value="{{ (isset($booking_details->period_from) ) ? \Carbon\Carbon::createFromFormat('Y-m-d',$booking_details->period_from )->format('d/m/Y') : \Carbon\Carbon::now()->format('d/m/Y') }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="period_to" class="period_to form-control period_to_date mt-2"
                                    placeholder="DD/MM/YYYY" value="{{ (isset($booking_details->period_to) ) ? \Carbon\Carbon::createFromFormat('Y-m-d',$booking_details->period_to )->format('d/m/Y') : \Carbon\Carbon::now()->addYear()->subDay(  )->format('d/m/Y') }}">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-container mt-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="unit-type" name="unit_type_id-{{ $item->id }}"
                                                ...
                                                @foreach ($unit_types as $unit_type)
                                                    <option value="{{ $unit_type->id }}" {{ $unit_type->id == $item->unit_type_id ? 'selected' : '' }}>{{ $unit_type->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="unit-condition" name="unit_condition_id-{{ $item->id }}"
                                                ...
                                                @foreach ($unit_conditions as $unit_condition)
                                                    <option value="{{ $unit_condition->id }}"  {{ $unit_condition->id == $item->unit_condition_id ? 'selected' : '' }}>{{ $unit_condition->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="preferred-view" name="view_id-{{ $item->id }}"
                                                ...
                                                @foreach ($views as $view)
                                                    <option value="{{ $view->id }}" {{ $view->id == $item->view_id ? 'selected' : '' }}>{{ $view->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex; gap: 10px;">
                                                <input type="text" name="period_from-{{ $item->id }}"
                                                    onchange="booking_unit_date_clc({{ $item->id }})"
                                                    id="period_from_date"
                                                    class="form-control main_data period_from_date text-white general_period_date"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="display: flex; gap: 10px;">
                                                <input type="text" name="period_to-{{ $item->id }}"
                                                    id="period_to_date"
                                                    class="form-control mt-2 main_data period_to_date text-white general_period_date_to"
                                                    value="{{ isset($item->expiry_date) ? \Carbon\Carbon::createFromFormat('Y-m-d', $item->expiry_date)->format('d/m/Y') : \Carbon\Carbon::now()->addYear()->subDay()->format('d/m/Y') }}">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @php
                                    $unit = App\Models\UnitManagement::where('id', $item->unit_id)
                                        ...
                                        ->first();
                                    $unit_services = App\Models\BookingUnitsService::where(
                                        'booking_unit_id',
                                        $item->id,
                                    )->get();
                                @endphp
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" readonly
                                                ...
                                                value="{{ $item->total_net_rent_amount }}" class="form-control"
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xl-3">
                                                    <div class="form-group">
                                                        <label for="charge_mode_type-{{ $item->id . '-' . ($key + 1) }}"
                                                            class="form-control-label">{{ ui_change('Charge_Mode' , 'property_transaction') }}</label> <span
                                                            class="starColor">*</span>
                                                        <select name="charge_mode_type-{{ $item->id . '-' . ($key + 1) }}[]"
                                                            class="form-control"
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xl-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            class="form-control text-white main_date "
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xl-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            class="text-white  main_date form-control"
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ $item->security_deposit }}" class="form-control"
                                                    step="0.001" placeholder="0.000">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="security_deposit_amount-{{ $item->id }}"
                                                    class="form-control" value="{{ $item->security_deposit_amount }}"  step="0.001" placeholder="0.000">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <select name="is_rent_inclusive_of_ewa-{{ $item->id }}"
                                                    class="js-select2-custom form-control">
                                                    <option {{ ($item->is_rent_inclusive_of_ewa == 'yes' ) ? 'selected' : ''  }}>{{ ui_change('yes' , 'property_transaction')  }}</option>
                                                    <option {{ ($item->is_rent_inclusive_of_ewa == 'no' ) ? 'selected' : ''  }}>{{ ui_change('no' , 'property_transaction')  }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <select name="ewa_limit_mode-{{ $item->id }}"
                                                    class="js-select2-custom form-control">
                                                    <option {{ ($item->is_rent_inclusive_of_ewa == 'no' ) ? 'selected' : ''  }} value="monthly">{{ ui_change('monthly' , 'property_transaction')  }}</option>
                                                    <option {{ ($item->is_rent_inclusive_of_ewa == 'no' ) ? 'selected' : ''  }}  value="yearly">{{ ui_change('yearly' , 'property_transaction') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="ewa_limit_monthly-{{ $item->id }}"
                                                    class="form-control"  value="{{ $item->ewa_limit}}"  step="0.001" value="0.000">
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <select name="notice_period-{{ $item->id }}"
                                                    class="js-select2-custom form-control">
                                                    <option value="one_month" {{ ($item->notice_period == 'one_month' ) ? 'selected' : ''  }}>{{ ui_change('one_month' , 'property_transaction') }}</option>
                                                    <option value="two_month" {{ ($item->notice_period == 'two_month' ) ? 'selected' : ''  }}>{{ ui_change('two_month' , 'property_transaction')  }}</option>
                                                    <option value="three_month" {{ ($item->notice_period == 'three_month' ) ? 'selected' : ''  }}>{{ ui_change('three_month' , 'property_transaction')  }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4 col-xl-6">
...
@push('script')
    <script>
       ...
       <script>
        function deleteItemService(button) {
            ...
            $.ajax({
                url: "{{ route('booking.empty_unit_from_service_booking', ':id') }}".replace(':id', itemId),
                type: "GET",
                data: {
                    _token: "{{ csrf_token() }}"
                },
    ...
    <script>
        ...
        flatpickr(".period_from_date", {
            dateFormat: "d/m/Y",
            defaultDate: "{{ isset($booking->booking_details->period_from) ? \Carbon\Carbon::createFromFormat('Y-m-d', $booking->booking_details->period_from)->format('d/m/Y') : '' }}",
            // minDate: "today"
        });
        flatpickr(".period_to_date", {
            dateFormat: "d/m/Y",
            defaultDate: "{{ isset($booking->booking_details->period_to) ? \Carbon\Carbon::createFromFormat('Y-m-d', $booking->booking_details->period_to)->format('d/m/Y') : '' }}",
            // minDate: "today"
        });
        flatpickr(".main_date", {
            dateFormat: "d/m/Y",
