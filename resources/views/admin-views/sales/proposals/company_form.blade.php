<div class="row">
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="registration_no" value="{{ (isset($proposal->customer)) ? $proposal->customer?->registration_no : '' }}">
        </div>
    </div>
    <div class="col-md-6 col-lg-4 col-xl-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="group_company_name" value="{{ (isset($proposal->customer)) ? $proposal->customer?->group_company_name : '' }}">
        </div>
    </div>
