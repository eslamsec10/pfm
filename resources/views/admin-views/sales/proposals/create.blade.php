...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        </div> <input type="hidden" id="decimals" name="decimals" value="{{ $company->decimals }}">
        <!-- Form -->
        <form id="productForm" class="product-form text-start" action="{{ route('proposal.store') }}" method="POST"
            ...
            <div class="row justify-content-end gap-3 mt-3 mx-1">
                ...
                <button type="submit" class="btn btn--primary px-5"
                    onclick="setFormAction('{{ route('proposal.store') }}')">{{ ui_change('submit', 'property_transaction') }}</button>
                <button type="submit" class="btn btn-warning px-5"
                    onclick="setFormAction('{{ route('proposal.search') }}')"><i
...
@push('script')
    ...
    `;
        ...
        function charge_type(i, j) {
            ...
            $.ajax({
                url: "{{ route('proposal.get_unit_service', ':id') }}".replace(':id', charge_type_amount),
                type: "GET",
                dataType: "json",
                success: function(data) {
                    ...
                    $('input[name="percentage_amount_charge-' + i + '-' + j + '[]"]').empty().val((0).toFixed(
                        decimals))
                },
                error: function(xhr, status, error) {
                    console.error('Error occurred:', error);
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="form-group">
                ...
                <div style="display: flex; gap: 10px;">
                    <input type="text" name="period_from-${i}" id="period-from" class="main_unit_data form-control main_data text-white general_period_date"  onchange="(proposal_unit_date_clc(${i}))" value="{{ \Carbon\Carbon::now()->format('d/m/Y') }}">
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="form-group">
                ...
                <div style="display: flex; gap: 10px;">
                    <input type="text" name="period_to-${i}" id="period-to" class="main_unit_data form-control mt-2 main_data text-white  general_period_date_to"  value="{{ \Carbon\Carbon::now()->subDay()->addYear()->format('d/m/Y') }}">
                </div>
            </div>
        </div>
    ...
    <div class="form-row">
        ...
        <div class="col-md-6 col-lg-4 col-xl-3 d-none" id="total_area_amount-${i}">
            <div class="form-group">
                ...
                <input type="number" disabled  name="total_area_amount-${i}" class="form-control" placeholder="${(0).toFixed(decimals)}"  >
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="form-group">
                ...
                <input type="number"   name="rent_amount-${i}" class="form-control" onkeyup="rent_mode_amount(${i}) , vat_amount_func(${i}), deposite(${i})"
                    step="0.001" placeholder="${(0).toFixed(decimals)}">
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="form-group">
                        ...
                        <input type="number"  onkeyup="deposite(${i})"  name="security_deposit_months_rent-${i}"
                            class="form-control" step="0.001" placeholder="${(0).toFixed(decimals)}">
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="form-group">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="form-group">
                        ...
                        <input type="number"  name="ewa_limit_monthly-${i}" class="form-control"
                            step="0.001" value="${(0).toFixed(decimals)}">
                    </div>
                </div>
                <div class="col-md-12 col-lg-4 col-xl-3">
                    <div class="form-group">
                        <label for="">{{ ui_change('lease_break_date', 'property_transaction') }}</label>
                        <input type="text" class="form-control main_unit_data text-white" name="lease_break_date-${i}"   value="{{ \Carbon\Carbon::now()->addMonth()->format('d/m/Y') }}">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="form-group">
                        ...
                        <select name="notice_period-${i}" class="js-select2-custom form-control">
                            <option value="1">{{ ui_change('one_month', 'property_transaction') }}</option>
                            <option value="2">{{ ui_change('two_month', 'property_transaction') }}</option>
                            <option value="3">{{ ui_change('three_month', 'property_transaction') }}</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-6">
