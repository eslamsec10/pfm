...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <form id="productForm" class="product-form text-start" action="{{ route('sales.proposal.update', $proposal->id) }}"
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" id="total-no-units" class="form-control"
                                    name="total_no_of_required_units" value="{{ $proposal->proposal_units->count() }}">
                            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 customer_form  @if ($proposal->customer?->type == 'individual') d-none @endif  company-form"
                            ...
                            @include('admin-views.sales.proposals.company_form')

                        </div>
                        <div class="col-md-12 customer_form @if ($proposal->customer?->type == 'company') d-none @endif personal-form"
                            id="personal-form">
                            @include('admin-views.sales.proposals.personal_form')
                        </div>
                    </div>
            ...
            <div id="main-content">
                @forelse ($proposal_unit_details as $item)
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <textarea id="notes" name="notes-{{ $item->id }}" class="form-control" rows="2">{{ $item->comment }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3  "
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="advance_percentage-{{ $item->id }}"
                                                class="form-control" value="{{ $item->advance_percentage }}"
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3  " id="advance_amount-{{ $item->id }}">
                                        <div class="form-group">
                                            ...
                                            <input type="number" readonly name="advance_amount-{{ $item->id }}"
                                                ...
                                                value="{{ number_format($item->advance_amount, $company->decimals) }}"
                                                step="0.001" placeholder="{{ number_format(0, $company->decimals) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3  "
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_installments-{{ $item->id }}"
                                                class="form-control" value="{{ $item->number_of_installments }}"
                                                step="0.001" placeholder="{{ number_format(0, $company->decimals) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <select name="payment_plan-{{ $item->id }}" class="form-control">
                                                <option value="1" {{ $item->payment_plan == 1 ? 'selected' : '' }}>
                                                    {{ ui_change('Monthly') }}</option>
                                                <option value="2" {{ $item->payment_plan == 2 ? 'selected' : '' }}>
                                                    {{ ui_change('Bimonthly') }}</option>
                                                <option value="3" {{ $item->payment_plan == 3 ? 'selected' : '' }}>
                                                    {{ ui_change('Quarterly') }}</option>
                                                <option value="4" {{ $item->payment_plan == 4 ? 'selected' : '' }}>
                                                    {{ ui_change('Semi_Anuual') }}</option>
                                                <option value="5" {{ $item->payment_plan == 5 ? 'selected' : '' }}>
                                                    {{ ui_change('Annual') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-lg-4 col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control start_date text-white"
                                                ...
                                                value="{{ isset($item->start_date) ? \Carbon\Carbon::createFromFormat('Y-m-d', $item->start_date)->format('d/m/Y') : \Carbon\Carbon::now()->format('d/m/Y') }}">
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    @foreach ($item->installments as $installment)
                                                        <tr>
                                                            <td>{{ $loop->index }}</td>
                                                            <td>
                                                                <input type="text" name="installment_date_${itemId}[]"
                                                                    class="form-control main_date text-white"
                                                                    value="{{ isset($installment->due_date) ? \Carbon\Carbon::createFromFormat('Y-m-d', $installment->due_date)->format('d/m/Y') : '' }}">
                                                            </td>
                                                            <td>
                                                                <input type="number"
                                                                    name="installment_amount_${itemId}[]"
                                                                    class="form-control"
                                                                    value="{{ number_format($installment->amount, $company->decimals) }}"
                                                                    step="0.001">
                                                            </td>
                                                        </tr>
                                                    @endforeach
...
@push('script')
    ...
    <script>
        function unitFunc(i) {
            ...
            $.ajax({
                url: "{{ route('sales.proposal.get_units') }}",
                type: "GET",
                data: {
