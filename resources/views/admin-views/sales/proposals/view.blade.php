...
@endphp 
@section('title')
    {{ ui_change('proposal_Info' , 'property_transaction') }} 
@endsection
@push('css_or_js')
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-10 justify-content-between mb-4">
                            <div class="d-flex flex-column gap-10">
                                ...
                                <h4 class="text-capitalize">{{ ui_change('proposal_no' , 'property_transaction') }} .#{{ $proposal->proposal_no }}</h4>
                                <div class="">
                                    <i class="tio-date-range"></i>
                                    {{ date('d M Y H:i:s', strtotime($proposal['proposal_date'])) }}
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('total_no_of_Units' , 'property_transaction') }} :
                                    <strong>{{ $proposal->total_no_of_required_units ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('status' , 'property_transaction') }} :
                                    <strong>{{ $proposal->status?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('Leasing_Executive' , 'property_transaction') }} :
                                    <strong>{{ $proposal->proposal_details->employee->name ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('agent' , 'property_transaction') }} :
                                    <strong>{{ $proposal->proposal_details?->agent?->name ?? $proposal->proposal_details?->agent?->company_name }}</strong></span>
                            </div>
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('Decision_Maker' , 'property_transaction') }} :
                                    <strong>{{ $proposal->proposal_details->decision_maker ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('decision_Maker_Designation' , 'property_transaction') }} :
                                    <strong>{{ $proposal->proposal_details->decision_maker_designation ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('current_Office_Location' , 'property_transaction') }} :
                                    <strong>{{ $proposal->proposal_details->current_office_location ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('reason_Of_Relocation' , 'property_transaction') }} :
                                    <strong>{{ $proposal->proposal_details->reason_of_relocation ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('time_Frame_For_Relocation' , 'property_transaction') }} :
                                    <strong>{{ $proposal->proposal_details->time_frame_for_relocation ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('relocation_date' , 'property_transaction') }} :
                                    <strong>{{ $proposal->proposal_details->relocation_date ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('Period_From' , 'property_transaction')  }} :
                                    <strong>{{ $proposal->proposal_details->period_from ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <span class="title-color break-all"> {{ ui_change('Period_To' , 'property_transaction') }} :
                                    <strong>{{ $proposal->proposal_details->period_to ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="media flex-wrap gap-3">
                                ...
                                <div class="media-body d-flex flex-column gap-1">
                                    <span class="title-color hover-c1"><strong>{{ $proposal->tenant->name ?? $proposal->tenant->company_name}}</strong></span>
                                    <span class="title-color hover-c1">{{ ui_change('gender' , 'property_transaction') }} :
                                        <strong>{{ $proposal->tenant->gender  ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                                    <span class="title-color"> {{ ui_change('contact_Person' , 'property_transaction') }} :
                                        <strong>{{ $proposal->tenant->contact_person  ?? ui_change('not_Available' , 'property_transaction') }}</strong>
                                    </span>
                                    <span class="title-color break-all"> {{ ui_change('contact_No' , 'property_transaction') }} :
                                        <strong>{{  $proposal->tenant->contact_no  ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                                    <span class="title-color break-all"> {{ ui_change('whatsapp' , 'property_transaction') }} :
                                        <strong>{{  $proposal->tenant->whatsapp_no  ?? ui_change('not_Available' , 'property_transaction') }}</strong></span> 
                                    <span class="title-color break-all">{{ ui_change('email1' , 'property_transaction') }} :
                                        <strong>{{ $proposal->tenant->email1  ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                                    <span class="title-color break-all">{{ ui_change('type' , 'property_transaction') }} :
                                        <strong>{{ ($proposal->tenant->type)  ?? ui_change('not_Available' , 'property_transaction')  }}</strong></span> 
                                    <span class="title-color break-all">{{ ui_change('address1' , 'property_transaction') }} :
                                        <strong>{{ $proposal->tenant->address1 ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                                    <span class="title-color break-all">{{ ui_change('address2' , 'property_transaction') }} :
                                        <strong>{{ $proposal->tenant->address2 ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                                    <span class="title-color break-all">{{ ui_change('address3' , 'property_transaction') }} :
                                        <strong>{{ $proposal->tenant->address3 ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                                    <span class="title-color break-all">{{ ui_change('state' , 'property_transaction') }} :
                                        <strong>{{ $proposal->tenant->state ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                                    <span class="title-color break-all">{{ ui_change('city' , 'property_transaction') }} :
                                        <strong>{{ $proposal->tenant->city ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                                    <span class="title-color break-all">{{ ui_change('country' , 'property_transaction') }} :
                                        <strong>{{ $proposal->tenant->country_master->country->name ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                                    <span class="title-color break-all">{{ ui_change('nationality' , 'property_transaction') }} :
                                        <strong>{{ $proposal->tenant->country_master->nationality_of_owner ?? ui_change('not_Available' , 'property_transaction') }}</strong></span> 
                                </div>
                            </div>
                        </div>
                    @else
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-10 justify-content-between mb-4">
                            <div class="d-flex flex-column gap-10">
                                ...
                                <h4 class="text-capitalize">{{ ui_change('id', 'property_transaction') }} # {{ $proposal->id }}</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6">
                                <span class="title-color break-all"> {{ ui_change('vat_no' , 'property_transaction')  }} :
                                    <strong>{{ $proposal->vat_no ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-6">
                                <span class="title-color break-all"> {{ ui_change('group_vat_no' , 'property_transaction')  }} :
                                    <strong>{{ $proposal->group_vat_no ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col-md-6 col-lg-6 col-xl-6">
                                <span class="title-color break-all"> {{ ui_change('tax_registration_date' , 'property_transaction')  }} :
                                    <strong>{{ Carbon\Carbon::parse($proposal->tax_reg_date)->format('Y-m-d') ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-6">
                                <span class="title-color break-all"> {{ ui_change('tax_rate' , 'property_transaction')  }} :
                                    <strong>{{ $proposal->tax_rate ?? ui_change('not_Available' , 'property_transaction') }}</strong></span>
                            </div>
...
@push('script_2')
    <script>
        ...
        function order_status(status) {
            @if ($proposal['order_status'] == 'delivered')
                Swal.fire({
    ...
    <script>
        function addDeliveryMan(id) {
            $.ajax({
                type: "GET",
                url: '{{ url('/') }}/admin/orders/add-delivery-man/{{ $proposal['id'] }}/' + id,
                data: {
