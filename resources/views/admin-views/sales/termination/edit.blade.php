...
@endphp
@section('title', ui_change('edit_termination' , 'property_transaction') )
    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center gap-3 mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{ ui_change('edit_termination' , 'property_transaction')  }}
            </h2> 
        </div>
        ...
        <!-- Form -->
        <form class="product-form text-start" action="{{ route('termination.update' , $termination->id) }}" method="POST"
            ...
            <div class="card mt-3 rest-part">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <h4 class="mb-0">{{ ui_change('edit_termination' , 'property_transaction') }}</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="applicant" value="{{ $termination->applicant }}">
                            </div>
                            @error('applicant')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="termination_start_date"
                                    name="termination_date" class="form-control" value="{{ (isset($termination->termination_date)) ? (\Carbon\Carbon::createFromFormat($termination->termination_date ,'Y-m-d')->format('d/m/Y')) : (\Carbon\Carbon::now()->format('d/m/Y')) }}">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <textarea name="comment" class="form-control" rows="1">{{ $termination->comment }}</textarea>
                        ...
                        <div class="col-md-12 col-lg-4 col-xl-6">
                            <div class="form-group">
                                ...
                                <select name="units[]" class="js-select2-custom form-control" multiple="multiple">
                                    <option value="-1" {{ in_array(-1, $units ?? []) ? 'selected' : '' }}>
                                        {{ ui_change('all' , 'property_transaction') }}
                                    </option>
                                    @foreach ($agreement_units as $agreement_units_item)
                                      <option value="{{ $agreement_units_item->id }}" {{ in_array($agreement_units_item->id, $units ?? []) ? 'selected' : '' }}>
